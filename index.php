...
<body class="bg-darkNew container-md" onload="counting()">
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent rounded-2 p-2">
        ...
        <div class="collapse navbar-collapse centered" id="headerCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link position-relative cart-count  text-success" href="dashboard/cart.php">
                        ...
                        <div class="items">
                            <?php
                                if (isset($_SESSION['c_shopping12']) && is_array($_SESSION['c_shopping12'])) {
                                    ...
                                    ?>
                            <div class="card all category shopping"
                                data-category="<?php echo $c_shopping12[$i]['category']; ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <button class="btn btn btn-gradient w-100 btn-show-payment" data-bs-toggle="modal"
                                        data-bs-target="#paymentModal"
                                        data-product-id="<?php echo $c_shopping12[$i]['product_id']; ?>"
    ...
    <!-- add to cart popup -->
    <div class="modal fade" id="paymentModal" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-darkNew text-white">
                ...
                <div class="modal-body pt-3 pb-2 bg-darkNew loadable-content loaded"
                    ...
                    <div class="main-content" style="display: block;">
                        ...
                        <div id="AmountDiv">
                            ...
                            <div class="input-group mb-4">
                                <input id="totalQuantity" placeholder="amount" type="number" value="1" min="1"
                                    max="15321" class="form-control">
                        ...
                        <button id="btnAddModal" type="button" class="btn btn-success w-100 mb-2 btn-add-to-cart "
    ...
    <script>
        ...
        function updateCartItemsCountAndTotal() {
            ...
            $.ajax({
                type: 'GET',
                url: 'dashboard/get_cart_items.php',
