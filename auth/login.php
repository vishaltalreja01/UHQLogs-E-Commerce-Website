...
// Check if there is an error message from the login process
...
<body class="bg-darkNew container-md">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent rounded-2 p-2">
        ...
        <div class="collapse navbar-collapse centered" id="headerCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item me-0 me-lg-2 mb-2 mb-lg-0">
                    <a class="nav-link btn btn-gradient " href="signup.php">create account</a>
                </li>
                <li class="nav-item">
    ...
    <div class="products full loadable-content">
        ...
        <div class="main-content auth" id="mainContent" style="color: rgba(255, 255, 255, 0.6);">
            ...
            <form action="../dashboard/index.php" class="form" method="post">
            <?php if($error_message != ""){ ?>
            <div style="width: 100%;background-color:aliceblue;border-radius:2.5rem;color:Black; text-align: center;height:10%;padding-top:1%;">
                <?php echo '<div >'.$error_message.'</div>'; ?>
            </div>
            <?php }?>
                <label for="paramLoginEmail">Email</label>
                <input class="form-control mb-3" placeholder="email@service.com" type="text" name="email" required>

                <label for="paramLoginPassword">Password</label>
                <input class="form-control mb-3" placeholder="password" type="password" name="pass" required>
                <div class="submit">
                    <input type="submit" class="btn btn-success mb-3 w-100" value="Login Now" class="submit">
                </div>
            </form>

            <p class="m-auto text-center text-white">Don't have an account? <a href="signup.php">create one</a> now</p>

            <p class="m-auto text-center text-white">Forgot password? <a href="forgotPassword.php">reset</a></p>
        </div>
    </div>
