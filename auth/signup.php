...
<head>
    ...
    <meta name="CHEAPEST MONEY LOGS! DOESN'T MATTER IF PAYPAL, CRYPTO, METHODS, WE GOT A BIG VARIETY TO FIT YOUR INTERESTS & MAKE MONEY OUT OF IT!" />
    <title>Signup | UHQ LOGS</title>
...
<body class="bg-darkNew container-md">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent rounded-2 p-2">
        ...
        <div class="collapse navbar-collapse centered" id="headerCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item me-0 me-lg-2 mb-2 mb-lg-0">
                    <a class="nav-link btn btn-gradient " href="#">create account</a>
                </li>
                <li class="nav-item">
    ...
    <div class="products full loadable-content">
        ...
        <div class="main-content auth" id="mainContent" style="color: rgba(255, 255, 255, 0.6);">
            <h5 class="mb-3 text-center text-white">Signup</h5>

            <form action="../php/signup.php" class="form" method="post">
                <div class="error-text">Error</div>
                <label for="paramSignupEmail">Email</label>
                <input class="form-control mb-3" placeholder="emai@service.com" type="email" name="email" required>

                <label for="paramSignupUsername">Username</label>
                <input class="form-control mb-3" placeholder="username" type="text" name="uname" required>

                <label for="paramSignupPassword">Password</label>
                <input class="form-control mb-3" placeholder="password" type="password" name="pass" required>

                <label for="paramSignupConfirmPassword">Confirm Password</label>
                <input class="form-control mb-3" placeholder="repeat password" type="password" name="cpass" required>

                <div class="submit">
                    <input type="submit" class="btn btn-success mb-3 w-100" value="Sign up">
                </div>
            </form>

            <p class="m-auto text-center text-white">Already have an account? <a href="login.php">login</a></p>
        </div>
    </div>
